...
// FilepathGlob. If passed, go_glob will treat all alphabetic characters as
...
// FilepathGlob. If passed, go_glob will abort and return IO errors when
...
// or FilepathGlob. If passed, go_glob will abort and return
// ErrPatternNotExist if the pattern references a path that does not exist
// before any meta characters such as `nonexistent/path/*`. Note that alts (ie,
...
// FilepathGlob. If passed, go_glob will only return files that match the
...
// FilepathGlob. If passed, go_glob will not follow symlinks while
...
// FilepathGlob. If passed, go_glob will not match hidden files and
...
//     directories
//
// On Windows, go_glob will check the file attributes and avoid hidden files
